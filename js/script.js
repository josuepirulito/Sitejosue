$(document).ready(function() {
    ...
    let circleD = new ProgressBar.Circle(containerD, {
        ...
        step: function(state, circle){
            ...
            let value = Math.round(circle.value() * 5445);
    ...
    //iniciando o loader quando o usuario chegar no final
